...
const StatusCard = ({ courseNumber, courseStatus, iconStatus }) => {
  ...
  return (
    <div
      className='flex overflow-hidden  h-36 md:py-0 px-3 mx-1 md:mx-3 md:mt-5 mb-8 rounded-md text-white'
      style={{ backgroundImage: 'linear-gradient(to bottom, #FC4F13, #F39C11)' , backgroundPosition: 'right'}}
    >
