...
const StatusCard = ({courseNumber, courseStatus, iconStatus}) => {
    ...
    return ( 
        <div className="flex w-fit  h-24 md:py-0 px-3 mx-1 md:mx-3 md:mt-5 mb-8 bg-gradient-to-b from-orange-600 to-orange-300 rounded-md text-white">
            ...
            <div className="w-fit h-fit relative">
                {Icons && <Icons className="text-6xl border-4 p-2 border-white rounded-lg relative  top-14 left-5" />}
            </div>
        </div>
     );
}
