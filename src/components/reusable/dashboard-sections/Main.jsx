  ...
  return (
    <div className=' space-y-8'>
      <div className=' space-y-2'>
        <h2 className='font-semibold text-lg w-fit h-fit'>In Progress</h2>
      ...
      <div className=' space-y-2'>
        <h2 className='font-semibold text-lg w-fit h-fit'>Completed</h2>
        <div className='flex space-x-4 w-full overflow-x-auto scroll-container'>
          <div>
            <CourseCard
          ...
          <div>
            <CourseCard
              courseTitle={'Hospitality Management'}
              courseImg={hm}
              courseStatus={'In Progress'}
              progressPercentage={'100%'}
            />
      ...
      <div className=' space-y-2'>
        <h2 className='font-semibold text-lg w-fit h-fit'>Suggested Courses</h2>
        <div className='flex space-x-4 w-full overflow-x-auto scroll-container'>
          <div>
            <NewCourseCard courseName={'3D Animation'} courseCost={'Free'} courseImg={des} />
          </div>
          <div>
            <NewCourseCard courseName={'UX Design'} courseCost={'Free'} courseImg={ux} />
          </div>
          <div>
            <NewCourseCard
