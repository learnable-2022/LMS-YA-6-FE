...
const Hero = () => {
    return ( 
        <div className="lg:mx-10 w-full overflow-x-hidden">
            <div className="overflow-x-hidden w-full md:w-5/6 h-fit p-3 md:mt-10 mb-10  bg-slate-300 rounded-sm md:flex justify-between items-center">
            ...
            <div className="flex flex-col md:w-3/5 ">
                ...
                <div className="md:flex space-y-3 md:space-y-0">
                    <div className="px-3 cursor-pointer bg-white rounded-lg md:w-1/4 min-w-fit h-10 md:h-fit flex justify-center items-center">View All Courses</div>
                    <div className="px-3 cursor-pointer bg-purple-900 rounded-lg text-white md:w-1/4 min-w-fit md:mx-4 h-10 md:h-fit flex justify-center items-center">Learn More</div>
                </div>
            </div>
        </div>
