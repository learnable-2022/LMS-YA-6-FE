...
const DropDownBtn = ({filterName, position}) => {
    ...
    return ( 
        <div className="md:relative inline-block" ref={filterRef}>
            <button
            type="button"
            className="flex items-center bg-white-200 shadow-xl border-4 border-white text-gray-700 rounded-full px-4 py-2 text-sm focus:outline-none"
