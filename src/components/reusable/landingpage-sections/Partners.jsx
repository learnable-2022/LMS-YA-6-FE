...
const Partners = () => {
  return (
    <div className='px-5 md:px-14 w-full lg:flex items-center justify-between bg-red-100 py-10 md:space-x-8'>
      ...
      <div className='mt-5 lg:mt-0 h-fit flex justify-center'>
