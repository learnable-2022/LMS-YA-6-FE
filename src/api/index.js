...
export const getCourses = (query = '') =>
  API.get(query === '' ? `/courses` : `/courses?search=${query}`);
export const getCourse = (id) => API.get(`/courses/${id}`);
export const enrollToCourse = (id, config) => API.patch(`/courses/${id}/enroll`, config);
export const progressodule = (courseId, moduleId, config) =>
  API.patch(`/courses/${courseId}/modules/${moduleId}`, config);
...
export const updateCourse = (id, formData, config) =>
  API.patch(`/instructor/courses/${id}`, formData, config);
export const createModules = (id, formData, config) =>
  API.post(`/instructor/courses/${id}/modules`, formData, config);
export const updateModules = (courseId, moduleId, formData, config) =>
  API.patch(`/instructor/courses/${courseId}/modules/${moduleId}`, formData, config);
